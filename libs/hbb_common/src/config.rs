...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("CC Remote".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rc.ccitel.net"];
pub const PUBLIC_RS_PUB_KEY: &str = "Xn3CfdIF3X5mPmRjDrGcYQKNiCrFBlQ7wC6Rhu6o1Ac=";
